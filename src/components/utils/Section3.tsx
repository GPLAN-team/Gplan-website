...
function Section3() {
  ...
  return (
    ...
    >
      ...
      >
        <Slide in={imageIsVisible} direction='left'  timeout={450} easing='ease-in-out'>
          <Box>
        <Typography
          marginLeft="32px"
          fontWeight="550"
        ...
        >
          ...
          hic velit excepturi rem eum explicabo quidem alias? Perferendis esse
          maxime rerum molestiae at ex deleniti provident porro eligendi
          cupiditate!
        </Typography>
        <Typography
          marginLeft="32px"
